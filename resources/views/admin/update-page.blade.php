...
@section('content')
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            <x-h2>{{__('Изменить страницу')}}</x-h2>

            <div class="w-full mb-4">
                <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
            </div>
                        <x-form action="{{ route('action-update') }}" method="POST">
                        ...
                        <div
                            ...
                            <div class="relative mb-4"><label for="content" class="leading-7 text-sm text-gray-600">{{__('Описание')}}</label>
                                <x-form.textarea name="content">{{ $post->content  }}</x-form.textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <x-form.input type="file"
                                              name="file-input" id="file-input" value=""
                                               />
                            </div>

                            <br>
                            <x-form.input type="submit"
                               value="{{_('Обновить страницу')}}" />
